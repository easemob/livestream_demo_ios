...
- (void)_setupLinkProtocol
{
    ...
    UIFont *linkFont = [UIFont fontWithName:@"PingFangSC-Semibold" size:12.0];
    ...
    [attributedString addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithWhite:1.0 alpha:1.0] range:[[attributedString string] rangeOfString:NSLocalizedString(@"servicePrompt", nil)]];
    [attributedString addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithWhite:1.0 alpha:1.0] range:[[attributedString string] rangeOfString:NSLocalizedString(@"privacyPrompt", nil)]];
    ...
    self.linkProtocol.textColor = [UIColor colorWithWhite:1.0 alpha:0.7];
